...
DEFAULT_CLASSIFIER_LIST = ["RandomForest", "KNN","DecisionTree"]  #"KNN", "SupportVectorMachine", "QuadraticDiscriminant", "NaiveBayes","Perceptron"
...
def comparative_data(fold, x_synthetic, real_data):
    ...
    return [synthetic_mean_squared_error, synthetic_cosine_similarity,
...
def evaluate_synthetic_data(list_classifiers, x_synthetic, y_synthetic, fold, k, generate_confusion_matrix,
                            output_dir, classifier_type, out_label, path_confusion_matrix, verbose_level,dict):
    instance_metrics = ProbabilisticMetrics()
...
def evaluate_real_data(list_classifiers, x_real, y_real, fold, k, generate_confusion_matrix, output_dir,
                       classifier_type, out_label, path_confusion_matrix, verbose_level,dict):
...
def show_and_export_results(dict_similarity, classifier_type, output_dir, title_output_label, dict_metrics):
    ...
    for index in range(len(classifier_type)):
        ...
        ## Logging dos resultados dos classificadores real
        logging.info("Overall real Results: Classifier {}\n".format(classifier_type[index]))
        ...
        plot_classifier_metrics.plot_classifier_metrics(
            ...
            dict_metrics["real accuracy"][classifier_type[index]],
            dict_metrics["real precision"][classifier_type[index]], 
            dict_metrics["real recall"][classifier_type[index]], 
            dict_metrics["real F1 score"][classifier_type[index]], 
            plot_filename,
            f'{title_output_label}_real',
        )

        logging.info("Overall synthetic Results: {}\n".format(classifier_type[index]))
        ...
        plot_classifier_metrics.plot_classifier_metrics(
            classifier_type[index], 
            dict_metrics["synthetic accuracy"][classifier_type[index]],
            dict_metrics["synthetic precision"][classifier_type[index]], 
            dict_metrics["synthetic recall"][classifier_type[index]], 
            dict_metrics["synthetic F1 score"][classifier_type[index]], 
            plot_filename,
    ...
    for metric, comparative_list in zip(comparative_metrics, comparative_lists):
        ...
        logging.info("\t\t{} - List     : {}".format(metric, dict_similarity[comparative_list]))
        logging.info("\t\t{} - Mean    : {}".format(metric, np.mean(dict_similarity[comparative_list])))
        logging.info("\t\t{} - Std. Dev.  : {}\n".format(metric, np.std(dict_similarity[comparative_list])))

    plot_filename = os.path.join(output_dir, f'Comparison_Real_Synthetic.pdf')
    
    plot_regressive_metrics.plot_regressive_metrics(
        dict_similarity["list_mean_squared_error"],
        dict_similarity["list_cosine_similarity"],
        dict_similarity["list_maximum_mean_discrepancy"],
        plot_filename,
...
def run_experiment(dataset, input_data_shape, k, classifier_list, output_dir, batch_size, training_algorithm,
    ...
    dict_similarity = {
        ...
        "list_maximum_mean_discrepancy": []
    }
    dict_metrics={"synthetic accuracy":{"RandomForest":[],"KNN":[],"DecisionTree":[], "Perceptron":[],"SupportVectorMachine":[],"SGDRegressor":[],"XGboost":[]},
         "real accuracy":{"RandomForest":[],"KNN":[],"DecisionTree":[], "Perceptron":[],"SupportVectorMachine":[],"SGDRegressor":[],"XGboost":[]},
         "synthetic precision":{"RandomForest":[],"KNN":[],"DecisionTree":[], "Perceptron":[],"SupportVectorMachine":[],"SGDRegressor":[],"XGboost":[]},
         "real precision":{"RandomForest":[],"KNN":[],"DecisionTree":[], "Perceptron":[],"SupportVectorMachine":[],"SGDRegressor":[],"XGboost":[]},
         "synthetic F1 score":{"RandomForest":[],"KNN":[],"DecisionTree":[], "Perceptron":[],"SupportVectorMachine":[],"SGDRegressor":[],"XGboost":[]},
         "real F1 score":{"RandomForest":[],"KNN":[],"DecisionTree":[],"Perceptron":[],"SupportVectorMachine":[],"SGDRegressor":[],"XGboost":[]},
         "synthetic recall":{"RandomForest":[],"KNN":[],"DecisionTree":[], "Perceptron":[],"SupportVectorMachine":[],"SGDRegressor":[],"XGboost":[]},
         "real recall":{"RandomForest":[],"KNN":[],"DecisionTree":[], "Perceptron":[],"SupportVectorMachine":[],"SGDRegressor":[],"XGboost":[]}}
    for i, (train_index, test_index) in enumerate(stratified.split(dataset.iloc[:, :-1], dataset.iloc[:, -1])):
        ...
        evaluate_synthetic_data(list_classifiers, x_synthetic_samples,
                                                                    y_synthetic_samples, i, k, True,
                                                                    output_dir, classifier_list, title_output,
                                                                    path_confusion_matrix, verbose_level,dict_metrics)

        evaluate_real_data(list_classifiers, x_test, y_test, i, k,
                                                          True, output_dir, classifier_list,
                                                          title_output, path_confusion_matrix, verbose_level,dict_metrics)

        comparative_metrics = comparative_data(i, x_synthetic_samples, x_test)
        dict_similarity["list_mean_squared_error"].append(comparative_metrics[0])
        dict_similarity["list_cosine_similarity"].append(comparative_metrics[1])
        dict_similarity["list_maximum_mean_discrepancy"].append(comparative_metrics[2])
        

    show_and_export_results(dict_similarity,classifier_list, output_dir, title_output,dict_metrics)
